...
/**
 * Class m123456_654321_2_key_jabatan
 * @property \yii\db\Transaction $_transaction
 * @Github https://github.com/Hzhihua
 */
class m123456_654321_2_key_jabatan extends Migration
{
    /**
     * @inheritdoc
     */
    public function safeUp()
    {
        ...
        $this->runSuccess['PRIMARY'] = $this->addPrimaryKey(null, '{{%jabatan}}', 'id');
        $this->runSuccess['addAutoIncrement'] = $this->addAutoIncrement('{{%jabatan}}', 'id', 'integer', '', 3);
    ...
    public function safeDown()
    {
        ...
        foreach ($this->runSuccess as $keyName => $value) {
            if ('addAutoIncrement' === $keyName) {
                ...
                $this->dropPrimaryKey(null, '{{%jabatan}}');
            } elseif (!empty($keyName)) {
                $this->dropIndex("`$keyName`", '{{%jabatan}}');
            }
        }
